...
public class MusicLoveEntity {
    ...
    @Generated(hash = 1337570518)
    public MusicLoveEntity(String songId, String time, String title, String author,
    ...
    @Generated(hash = 1346537112)
    public MusicLoveEntity() {
    }
